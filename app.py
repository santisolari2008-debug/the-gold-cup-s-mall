...
# 2. INICIALIZACIÓN DEL CATÁLOGO DE 15 PRODUCTOS CON IMÁGENES REALES
if "catalogo" not in st.session_state:
    st.session_state.catalogo = [
        ...
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1599408012629-672958374828?w=500&auto=format&fit=crop&q=60"
        ),
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1563071374-1cd4c08e58da?w=500&auto=format&fit=crop&q=60"
        ),
        ProductoMundial(
        ...
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1606167668584-78701c57f13d?w=500&auto=format&fit=crop&q=60"
        ),
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1551854838-212c50b4c184?w=500&auto=format&fit=crop&q=60"
        ),
        ProductoMundial(
        ...
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1508847154043-be12a62861c1?w=500&auto=format&fit=crop&q=60"
        ),
        ProductoMundial(
        ...
        ProductoMundial(
            ...
            "https://images.unsplash.com/photo-1578269174936-2709b5a190f8?w=500&auto=format&fit=crop&q=60"
        )
    ]
...
# Estilos visuales corporativos de la FIFA: Fondos azul oscuro, realces dorados y tarjetas limpias
st.markdown("""
    <style>
    ...
    /* Diseño estilizado de tarjetas de producto con temática de campeonato */
    .product-card { background-color: #FFFFFF; border-radius: 10px; border-top: 4px solid #8A7322; padding: 22px; box-shadow: 0 4px 12px rgba(12,35,64,0.06); margin-bottom: 20px; transition: transform 0.2s; }
...
# Pestañas de Navegación del Sistema (Corporativas)
...
with tab_catalogo:
    ...
    # Procesamiento algorítmico de filtros basados en registros de la Unidad 2
    productos_filtrados = []
    ...
    # Renderizado del catálogo con maquetación limpia e imágenes reales
    if productos_filtrados:
        for p in productos_filtrados:
            st.markdown('<div class="product-card">', unsafe_allow_html=True)
            c_img, c_desc, c_precio, c_accion = st.columns([2, 4, 2, 1])
            
            with c_img:
                # Carga de imágenes reales con ajuste de contenedor dinámico
    ...
    # MENSAJE INFORMATIVO DE VERSIÓN DEMO (Requisito de cierre del catálogo)
    st.markdown("""
